    ...
    return (
        <motion.div 
            ...
            <div className="relative h-64 w-64 rounded-2xl shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px]">
                <motion.img
                    layoutId={`card-image-${data.referenceNumber}`}
                    src={data.img}
                    alt={data.name}
                ...
                />
                <motion.span 
                    layoutId={`card-brand-${data.referenceNumber}`}
                    className="absolute top-2 left-2 bg-neutral-800 text-white text-xs font-semibold px-2 py-1 rounded">
                    {data.brand}
                </motion.span>
            </div>
            ...
            <div className="flex flex-col items-center p-3 gap-1 w-full text-center">
                <motion.h2 
                    layoutId={`card-title-${data.referenceNumber}`}
